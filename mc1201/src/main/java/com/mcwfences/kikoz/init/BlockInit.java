...
public class BlockInit {
	...
	public static final RegistryObject<Block> OAK_HEDGE = BLOCKS.register("oak_hedge", () -> new WallBlock(Block.Properties.copy(Blocks.OAK_LEAVES)));
	public static final RegistryObject<Block> SPRUCE_HEDGE = BLOCKS.register("spruce_hedge", () -> new WallBlock(Block.Properties.copy(Blocks.SPRUCE_LEAVES)));
	public static final RegistryObject<Block> BIRCH_HEDGE = BLOCKS.register("birch_hedge", () -> new WallBlock(Block.Properties.copy(Blocks.BIRCH_LEAVES)));
	public static final RegistryObject<Block> JUNGLE_HEDGE = BLOCKS.register("jungle_hedge", () -> new WallBlock(Block.Properties.copy(Blocks.JUNGLE_LEAVES)));
	public static final RegistryObject<Block> ACACIA_HEDGE = BLOCKS.register("acacia_hedge", () -> new WallBlock(Block.Properties.copy(Blocks.ACACIA_LEAVES)));
	public static final RegistryObject<Block> DARK_OAK_HEDGE = BLOCKS.register("dark_oak_hedge", () -> new WallBlock(Block.Properties.copy(Blocks.DARK_OAK_LEAVES)));
	public static final RegistryObject<Block> MANGROVE_HEDGE = BLOCKS.register("mangrove_hedge", () -> new WallBlock(Block.Properties.copy(Blocks.MANGROVE_LEAVES)));
	public static final RegistryObject<Block> AZALEA_HEDGE = BLOCKS.register("azalea_hedge", () -> new WallBlock(Block.Properties.copy(Blocks.AZALEA_LEAVES)));
	public static final RegistryObject<Block> FLOWERING_AZALEA_HEDGE = BLOCKS.register("flowering_azalea_hedge", () -> new WallBlock(Block.Properties.copy(Blocks.FLOWERING_AZALEA_LEAVES)));
	...
	public static final RegistryObject<Block> OAK_HIGHLEY_GATE = BLOCKS.register("oak_highley_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).strength(1.4F, 2.0F).sound(SoundType.WOOD), WoodType.OAK));
	public static final RegistryObject<Block> SPRUCE_HIGHLEY_GATE = BLOCKS.register("spruce_highley_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).strength(1.4F, 2.0F).sound(SoundType.WOOD), WoodType.SPRUCE));
	public static final RegistryObject<Block> BIRCH_HIGHLEY_GATE = BLOCKS.register("birch_highley_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).strength(1.4F, 2.0F).sound(SoundType.WOOD), WoodType.BIRCH));
	public static final RegistryObject<Block> JUNGLE_HIGHLEY_GATE = BLOCKS.register("jungle_highley_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).strength(1.4F, 2.0F).sound(SoundType.WOOD), WoodType.JUNGLE));
	public static final RegistryObject<Block> ACACIA_HIGHLEY_GATE = BLOCKS.register("acacia_highley_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).strength(1.4F, 2.0F).sound(SoundType.WOOD), WoodType.ACACIA));
	public static final RegistryObject<Block> DARK_OAK_HIGHLEY_GATE = BLOCKS.register("dark_oak_highley_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).strength(1.4F, 2.0F).sound(SoundType.WOOD), WoodType.DARK_OAK));
	public static final RegistryObject<Block> CRIMSON_HIGHLEY_GATE = BLOCKS.register("crimson_highley_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.of().mapColor(MapColor.CRIMSON_STEM).strength(1.4F, 2.0F).sound(SoundType.WOOD), WoodType.CRIMSON));
	public static final RegistryObject<Block> WARPED_HIGHLEY_GATE = BLOCKS.register("warped_highley_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WARPED_STEM).strength(1.4F, 2.0F).sound(SoundType.WOOD), WoodType.WARPED));
	public static final RegistryObject<Block> MANGROVE_HIGHLEY_GATE = BLOCKS.register("mangrove_highley_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).strength(1.4F, 2.0F).sound(SoundType.WOOD), WoodType.MANGROVE));

	public static final RegistryObject<Block> OAK_PYRAMID_GATE = BLOCKS.register("oak_pyramid_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).strength(1.4F, 2.0F).sound(SoundType.WOOD), WoodType.OAK));
	public static final RegistryObject<Block> SPRUCE_PYRAMID_GATE = BLOCKS.register("spruce_pyramid_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).strength(1.4F, 2.0F).sound(SoundType.WOOD), WoodType.SPRUCE));
	public static final RegistryObject<Block> BIRCH_PYRAMID_GATE = BLOCKS.register("birch_pyramid_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).strength(1.4F, 2.0F).sound(SoundType.WOOD), WoodType.BIRCH));
	public static final RegistryObject<Block> JUNGLE_PYRAMID_GATE = BLOCKS.register("jungle_pyramid_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).strength(1.4F, 2.0F).sound(SoundType.WOOD), WoodType.JUNGLE));
	public static final RegistryObject<Block> ACACIA_PYRAMID_GATE = BLOCKS.register("acacia_pyramid_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).strength(1.4F, 2.0F).sound(SoundType.WOOD), WoodType.ACACIA));
	public static final RegistryObject<Block> DARK_OAK_PYRAMID_GATE = BLOCKS.register("dark_oak_pyramid_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).strength(1.4F, 2.0F).sound(SoundType.WOOD), WoodType.DARK_OAK));
	public static final RegistryObject<Block> CRIMSON_PYRAMID_GATE = BLOCKS.register("crimson_pyramid_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.of().mapColor(MapColor.CRIMSON_STEM).strength(1.4F, 2.0F).sound(SoundType.WOOD), WoodType.CRIMSON));
	public static final RegistryObject<Block> WARPED_PYRAMID_GATE = BLOCKS.register("warped_pyramid_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WARPED_STEM).strength(1.4F, 2.0F).sound(SoundType.WOOD), WoodType.WARPED));
	public static final RegistryObject<Block> MANGROVE_PYRAMID_GATE = BLOCKS.register("mangrove_pyramid_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).strength(1.4F, 2.0F).sound(SoundType.WOOD), WoodType.MANGROVE));
	...
	public static final RegistryObject<Block> STONE_BRICK_RAILING_GATE = BLOCKS.register("stone_brick_railing_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops(), WoodType.OAK));
	public static final RegistryObject<Block> ANDESITE_RAILING_GATE = BLOCKS.register("andesite_railing_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops(), WoodType.OAK));
	public static final RegistryObject<Block> DIORITE_RAILING_GATE = BLOCKS.register("diorite_railing_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops(), WoodType.OAK));
	public static final RegistryObject<Block> GRANITE_RAILING_GATE = BLOCKS.register("granite_railing_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops(), WoodType.OAK));
	public static final RegistryObject<Block> SANDSTONE_RAILING_GATE = BLOCKS.register("sandstone_railing_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops(), WoodType.OAK));
	public static final RegistryObject<Block> RED_SANDSTONE_RAILING_GATE = BLOCKS.register("red_sandstone_railing_gate", () -> new FenceGateBlock(Block.Properties.of().mapColor(MapColor.COLOR_ORANGE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops(), WoodType.OAK));
	public static final RegistryObject<Block> BLACKSTONE_RAILING_GATE = BLOCKS.register("blackstone_railing_gate", () -> new FenceGateBlock(Block.Properties.of().mapColor(MapColor.COLOR_BLACK).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops(), WoodType.OAK));
	public static final RegistryObject<Block> BLACKSTONE_BRICK_RAILING_GATE = BLOCKS.register("blackstone_brick_railing_gate", () -> new FenceGateBlock(Block.Properties.of().mapColor(MapColor.COLOR_BLACK).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops(), WoodType.OAK));
	public static final RegistryObject<Block> NETHER_BRICK_RAILING_GATE = BLOCKS.register("nether_brick_railing_gate", () -> new FenceGateBlock(Block.Properties.of().mapColor(MapColor.NETHER).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops(), WoodType.OAK));
	public static final RegistryObject<Block> END_BRICK_RAILING_GATE = BLOCKS.register("end_brick_railing_gate", () -> new FenceGateBlock(Block.Properties.of().mapColor(MapColor.TERRACOTTA_YELLOW).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops(), WoodType.OAK));
	public static final RegistryObject<Block> DEEPSLATE_RAILING_GATE = BLOCKS.register("deepslate_railing_gate", () -> new FenceGateBlock(Block.Properties.of().mapColor(MapColor.DEEPSLATE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops(), WoodType.OAK));
	public static final RegistryObject<Block> DEEPSLATE_BRICK_RAILING_GATE = BLOCKS.register("deepslate_brick_railing_gate", () -> new FenceGateBlock(Block.Properties.of().mapColor(MapColor.DEEPSLATE).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops(), WoodType.OAK));
	public static final RegistryObject<Block> QUARTZ_RAILING_GATE = BLOCKS.register("quartz_railing_gate", () -> new FenceGateBlock(Block.Properties.of().mapColor(MapColor.QUARTZ).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops(), WoodType.OAK));
	public static final RegistryObject<Block> MUD_BRICK_RAILING_GATE = BLOCKS.register("mud_brick_railing_gate", () -> new FenceGateBlock(Block.Properties.of().mapColor(MapColor.COLOR_BROWN).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops(), WoodType.OAK));
	public static final RegistryObject<Block> PRISMARINE_RAILING_GATE = BLOCKS.register("prismarine_railing_gate", () -> new FenceGateBlock(Block.Properties.of().mapColor(MapColor.COLOR_CYAN).strength(2.0F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops(), WoodType.OAK));
	...
	public static final RegistryObject<Block> CHERRY_HIGHLEY_GATE = BLOCKS.register("cherry_highley_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).strength(1.4F, 2.0F).sound(SoundType.CHERRY_WOOD), WoodType.CHERRY));
	public static final RegistryObject<Block> CHERRY_PYRAMID_GATE = BLOCKS.register("cherry_pyramid_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).strength(1.4F, 2.0F).sound(SoundType.CHERRY_WOOD), WoodType.CHERRY));
	...
	public static final RegistryObject<Block> BAMBOO_HIGHLEY_GATE = BLOCKS.register("bamboo_highley_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).strength(1.4F, 2.0F).sound(SoundType.BAMBOO_WOOD), WoodType.CHERRY));
	public static final RegistryObject<Block> BAMBOO_PYRAMID_GATE = BLOCKS.register("bamboo_pyramid_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).strength(1.4F, 2.0F).sound(SoundType.BAMBOO_WOOD), WoodType.CHERRY));
